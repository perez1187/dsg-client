...
const rows = [
  { id: 'Alisson - Patrick', profitLoss: '27,061,25', rakeUsd: '940', deal: '40%', agentSettlement: "24,667.13", clubSettlement: "27,632,81", profitUsd: "75%", action: "" },
  
];

export default function AffiliatesPerformance(props) {
 
  return (
    <>
      <Box className="cmmn-box m-t-24">
        <Typography component="h4" className='cmmn-box-title'>Affiliates l Players Performance</Typography>
