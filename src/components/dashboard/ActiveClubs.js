...
function createData(id, name, union, club, clubid, admin, refid, totalrevenue) {
  return {
    id,
    name,
    union,
...
const rows = [
  createData(1, 'Name app', 'Union', 'Club', 'Club ID', '% Admin', 'Ref ID', '$970,79'),
  createData(1, 'Name app', 'Union', 'Club', 'Club ID', '% Admin', 'Ref ID', '$970,79'),
  createData(1, 'Name app', 'Union', 'Club', 'Club ID', '% Admin', 'Ref ID', '$970,79'),
  createData(1, 'Name app', 'Union', 'Club', 'Club ID', '% Admin', 'Ref ID', '$970,79'),
];
...
export default function ActiveClubs(props) {
  const [order, setOrder] = React.useState('asc');
  const [orderBy, setOrderBy] = React.useState('union');
