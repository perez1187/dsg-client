...
const rows = [
  { id: 'MiamiBallers', players: '957072', nickname: 'Verners1', agents: 'Verners1', profitLoss: "$9,906,4", rake: "$5,882,49", deal: "75%", rakeback: "$970,79", agentSettlement: "$ 12,739,38", action: "" },
  ...
  return (
    <>
      <Box className="cmmn-box m-t-24">
        <Typography component="h4" className='cmmn-box-title'>Club l Players l Agents in USD</Typography>
